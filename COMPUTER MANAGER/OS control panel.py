...
panel=PhotoImage(file="panel.png")
...
detentime=PhotoImage(file="dt.png")
...
system=PhotoImage(file="system.png")
...
device=PhotoImage(file="device.png")
...
properties=PhotoImage(file="properties.png")
...
uninstall=PhotoImage(file="uninstall.png")
...
network=PhotoImage(file="network.png")
