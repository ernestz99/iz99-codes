...
task=PhotoImage(file="COMPUTER MANAGER/task.png")
...
panel=PhotoImage(file="COMPUTER MANAGER/panel.png")
...
detentime=PhotoImage(file="COMPUTER MANAGER/dt.png")
...
system=PhotoImage(file="COMPUTER MANAGER/system.png")
...
device=PhotoImage(file="COMPUTER MANAGER/device.png")
...
update=PhotoImage(file="COMPUTER MANAGER/update.png")
...
mouse=PhotoImage(file="COMPUTER MANAGER/mouse.png")
...
properties=PhotoImage(file="COMPUTER MANAGER/properties.png")
...
uninstall=PhotoImage(file="COMPUTER MANAGER/uninstall.png")
...
network=PhotoImage(file="COMPUTER MANAGER/network.png")
...
end=PhotoImage(file="COMPUTER MANAGER/end.png")
