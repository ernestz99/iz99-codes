...
def call_us():
    def talk():
        ...
        call2 = ImageTk.PhotoImage(file='DISCOUNT STORE & CUSTOMER CARE/images/call2.png')
    ...
    grp = ImageTk.PhotoImage(file='DISCOUNT STORE & CUSTOMER CARE/images/grp.png')
    ...
    back = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/back.png")
...
def faqq():
    ...
    ff = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/faq2.png")
    back = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/back.png")
...
def chatt():
    ...
    admin = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/admin.png")
    back = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/back.png")
    send = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/send.png")
    you = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/you.png")
...
call= ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/call.png")
chat = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/chat1.png")
mail = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/mail.png")
faq = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/faq.png")
back = ImageTk.PhotoImage(file="DISCOUNT STORE & CUSTOMER CARE/images/back.png")
