...
def call_us():
    def talk():
        ...
        call2 = ImageTk.PhotoImage(file='call2.png')
    ...
    grp = ImageTk.PhotoImage(file='grp.png')
    ...
    back = ImageTk.PhotoImage(file="back.png")
...
def faqq():
    ...
    ff = ImageTk.PhotoImage(file="faq2.png")
    back = ImageTk.PhotoImage(file="back.png")
...
def chatt():
    ...
    admin = ImageTk.PhotoImage(file="admin.png")
    back = ImageTk.PhotoImage(file="back.png")
    send = ImageTk.PhotoImage(file="send.png")
    you = ImageTk.PhotoImage(file="you.png")
...
call= ImageTk.PhotoImage(file="call.png")
chat = ImageTk.PhotoImage(file="chat1.png")
mail = ImageTk.PhotoImage(file="mail.png")
faq = ImageTk.PhotoImage(file="faq.png")
back = ImageTk.PhotoImage(file="back.png")
