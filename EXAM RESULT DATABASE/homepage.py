...
def submit():
    ...
    if(exam_num == "" or exam_num == "    Examination number"):
        ...
        if row==None:
            ...
            #wrapper1
            w1Image=ImageTk.PhotoImage(file='logo.png')
            ...
            w3Image=ImageTk.PhotoImage(file='bulb.png')
...
win.config(bg="White")
win.resizable(0,0)
bgImage=ImageTk.PhotoImage(file='pic1.jpg')
bgL=Label(win, image=bgImage).grid()

icon=PhotoImage(file="student.png")
...
send=PhotoImage(file="submit1.png")
