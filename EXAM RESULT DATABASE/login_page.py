...
def hide():
    closeye.config(file='EXAM RESULT DATABASE/images/closeye.png')
    passE.config(show='*')
    eyeB.config(command=show)

def show():
    closeye.config(file='EXAM RESULT DATABASE/images/openeye.png')
    passE.config(show='') 
...
bgImage=ImageTk.PhotoImage(file='EXAM RESULT DATABASE/images/bg.jpg')
...
closeye=PhotoImage(file='EXAM RESULT DATABASE/images/closeye.png')
...
fb=PhotoImage(file='EXAM RESULT DATABASE/images/facebook.png')
fbL=Label(win, image=fb, bg="white")
fbL.place(x=640, y=440)

google=PhotoImage(file='EXAM RESULT DATABASE/images/google.png')
gL=Label(win, image=google, bg="white")
gL.place(x=700, y=440)

twitter=PhotoImage(file='EXAM RESULT DATABASE/images/twitter.png')
