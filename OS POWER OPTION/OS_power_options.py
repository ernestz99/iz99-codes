...
bgImage=ImageTk.PhotoImage(file='OS POWER OPTION/images/power.jpg')
...
Sicon=PhotoImage(file='OS POWER OPTION/images/shutdown.png')
...
Ricon=PhotoImage(file='OS POWER OPTION/images/restart.png')
...
Licon=PhotoImage(file='OS POWER OPTION/images/exit.png')
