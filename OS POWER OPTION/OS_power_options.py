...
bgImage=ImageTk.PhotoImage(file='OS POWER OPTION/power.jpg')
...
Sicon=PhotoImage(file='OS POWER OPTION/shutdown.png')
...
Ricon=PhotoImage(file='OS POWER OPTION/restart.png')
...
Licon=PhotoImage(file='OS POWER OPTION/exit.png')
